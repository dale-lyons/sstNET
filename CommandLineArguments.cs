...
namespace sstNET
{
    ...
    public sealed class Parser
    {
        ...
        /// <summary>
        /// Parses Command Line Arguments. Displays usage message to _console.Out
        /// if /?, /help or invalid arguments are encounterd.
        /// Errors are output on _console.Error.
        /// Use ArgumentAttributes to control parsing behaviour.
        /// </summary>
        /// <param name="arguments"> The actual arguments. </param>
        /// <param name="destination"> The resulting parsed arguments. </param>
        /// <returns> true if no errors were detected. </returns>
        public static bool ParseArgumentsWithUsage(string[] arguments, object destination, ErrorReporter reporter)
        {
            if (Parser.ParseHelp(arguments) || !Parser.ParseArguments(arguments, destination, reporter))
            {
                // error encountered in arguments. Display usage message
                reporter(Parser.ArgumentsUsage(destination.GetType()));
//                System._console.Write(Parser.ArgumentsUsage(destination.GetType()));
                return false;
            }
